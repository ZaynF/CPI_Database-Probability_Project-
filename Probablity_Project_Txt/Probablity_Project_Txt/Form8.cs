...
namespace Probablity_Project_Txt
{
    public partial class Form8 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (choose_item7.SelectedItem.ToString() == "美容及衛生用品")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("美容及衛生用品.txt");
                for (int i = 0; i < 197; i++)
                {
            ...
            else if (choose_item7.SelectedItem.ToString() == "個人隨身用品")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("個人隨身用品.txt");
                for (int i = 0; i < 197; i++)
                {
                    month = sr_mon.ReadLine();
                    if (begin_mon.SelectedItem.ToString() == month) pos1 = i;
            ...
            else if (choose_item7.SelectedItem.ToString() == "個人服務")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("個人服務.txt");
                for (int i = 0; i < 197; i++)
                {
                    month = sr_mon.ReadLine();
                    if (begin_mon.SelectedItem.ToString() == month) pos1 = i;
            ...
            else if (choose_item7.SelectedItem.ToString() == "理容服務費")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("理容服務費.txt");
                for (int i = 0; i < 197; i++)
                {
                    month = sr_mon.ReadLine();
                    if (begin_mon.SelectedItem.ToString() == month) pos1 = i;
            ...
            else if (choose_item7.SelectedItem.ToString() == "其他")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("其他.txt");
                for (int i = 0; i < 197; i++)
                {
                    month = sr_mon.ReadLine();
                    if (begin_mon.SelectedItem.ToString() == month) pos1 = i;
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (choose_item7.SelectedItem.ToString() == "美容及衛生用品")
            {
                try
                {
                    ...
                    System.Diagnostics.Process.Start("美容及衛生用品.html");
                }
                catch (Exception ex)
                {
            ...
            else if (choose_item7.SelectedItem.ToString() == "個人隨身用品")
            {
                ...
                {
                    linkLabel1.LinkVisited = true;
                    System.Diagnostics.Process.Start("個人隨身用品.html");
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Unable to open link that was clicked.");
            ...
            else if (choose_item7.SelectedItem.ToString() == "個人服務")
            {
                ...
                {
                    linkLabel1.LinkVisited = true;
                    System.Diagnostics.Process.Start("個人服務.html");
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Unable to open link that was clicked.");
            ...
            else if (choose_item7.SelectedItem.ToString() == "理容服務費")
            {
                ...
                {
                    linkLabel1.LinkVisited = true;
                    System.Diagnostics.Process.Start("理容服務費.html");
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Unable to open link that was clicked.");
            ...
            else if (choose_item7.SelectedItem.ToString() == "其他")
            {
                ...
                {
                    linkLabel1.LinkVisited = true;
                    System.Diagnostics.Process.Start("其他.html");
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Unable to open link that was clicked.");
