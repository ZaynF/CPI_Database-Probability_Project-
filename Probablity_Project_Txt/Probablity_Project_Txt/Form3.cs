...
namespace Probablity_Project_Txt
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (choose_item2.SelectedItem.ToString() == "成衣類")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("成衣類.txt");
                for (int i = 0; i < 197; i++)
                {
            ...
            else if (choose_item2.SelectedItem.ToString() == "鞋類")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("鞋類.txt");
                for (int i = 0; i < 197; i++)
                {
                    month = sr_mon.ReadLine();
                    if (begin_mon.SelectedItem.ToString() == month) pos1 = i;
            ...
            else if (choose_item2.SelectedItem.ToString() == "衣著服務及配件")
            {
                StreamReader sr_mon = new StreamReader("Month.txt");
                StreamReader sr = new StreamReader("衣著服務及配件.txt");
                for (int i = 0; i < 197; i++)
                {
                    month = sr_mon.ReadLine();
                    if (begin_mon.SelectedItem.ToString() == month) pos1 = i;
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (choose_item2.SelectedItem.ToString() == "成衣類")
            {
                try
                {
                    ...
                    System.Diagnostics.Process.Start("成衣類.html");
                }
                catch (Exception ex)
                {
            ...
            else if (choose_item2.SelectedItem.ToString() == "鞋類")
            {
                ...
                {
                    linkLabel1.LinkVisited = true;
                    System.Diagnostics.Process.Start("鞋類.html");
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Unable to open link that was clicked.");
            ...
            else if (choose_item2.SelectedItem.ToString() == "衣著服務及配件")
            {
                ...
                {
                    linkLabel1.LinkVisited = true;
                    System.Diagnostics.Process.Start("衣著服務及配件.html");
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Unable to open link that was clicked.");
